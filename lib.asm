...
parse_uint:
 ...
 .loop:
  ...
  sub r10b, '0'   ; сразу вычитаем '0' (перевод из ascii в число)
  jl .end     ; если получили меньше 0, то и символ был неподходящий (иначе получили бы >= 0)
        ; проверка на 0 включается в это условие ( 0 - '0' < 0)
  cmp r10b, 9
  jg .end
