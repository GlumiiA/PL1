...
read_word:
  ...
  .read_loop:
    cmp rax, 0x0     ; Null-terminator => full read
    je .full_read
    cmp rax, 0x20    ; Space => full read
    je .full_read
    cmp rax, 0x9      ; Tab => full read
    je .full_read
    cmp rax, 0xA  ; Newline => full read
    je .full_read
  ...
  .full_read:
    mov byte [r12], 0x0  ; Add null-terminator to word
    pop r13
    pop r12
